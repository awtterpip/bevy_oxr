...
pub fn update_xr_stuff(world: &mut World) {
    ...
    info!("Should have been run by now!");
...
fn init_non_xr_graphics(primary_window: Option<RawHandleWrapper>) -> RenderCreationData {
